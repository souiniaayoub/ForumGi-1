				...
				<div class="row course_boxes">
					...
					foreach ($courses as $course) { ?>
						<div class="col-lg-4 course_box">
							<div class="card">
								<img class="card-img-top" src="<?php echo $course['imageCourse']; ?>" height="250px" alt="<?php echo $course['nameCourse']; ?> Course">
								<div class="card-body text-center">
									<div class="card-title"><a href="courses.php?id"><?php echo $course['nameCourse']; ?></a></div>
								...
								<div class="price_box d-flex flex-row align-items-center">
									...
									<div class="course_author_name"><span>Author:</span> <?php echo $course['nameTeach']; ?></div>
